...
############# Figure S2 ###############
#pdf(file = "figures/S2.pdf", width = 10, height = 3) 
...
legend("topright", legend = c("Effect for biotic filter strength from Delavaux et al., 2024", "Effect for corrected biotic filter strength"), col = c("grey", "black"), pch = 15, bty = "n")
